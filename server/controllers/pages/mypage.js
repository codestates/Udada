    ...
    get: (req, res) => {
        ...
        if (accessTokenData) {
            ...
            if (petuserData && !petsitterData) {
                ...
                return res.status(200).json({ data: { petuserData: petuserData }, messages: "ok" })
            }
            if (petsitterData && !petuserData) {
                delete petsitterData.password
                return res.status(200).json({ data: { petsitterData: petsitterData }, messages: "ok" })
            }
        ...
        if (!accessTokenData && !refreshTokenData) {
            console.log("----------no acceesToken login---------")
